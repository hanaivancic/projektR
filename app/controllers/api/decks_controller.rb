module Api
  class DecksController < ApplicationController
    ...
    def index
      render json: DeckSerializer.render_as_json(Deck.where(student_id: @current_user).or(Deck.where(classrom_id: @current_user.classroom)).order(name: :asc), root: 'decks')
    end
